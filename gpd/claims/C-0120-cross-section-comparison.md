...
| **Consumes** | [`C-0119`](C-0119-honeycomb-raster-width.md) (the published cross-sections and the yield ordering), [`C-0109`](C-0109-four-layer-tile.md) (the rigidity machinery), [`C-0116`](C-0116-composite-fraction-threshold.md) (the threshold, re-read per cross-section), [`C-0022`](C-0022-tile-edge-load.md), [`C-0086`](C-0086-seamless-scaffold-routing.md) |
