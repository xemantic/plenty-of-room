...
| **Conditions** | Honeycomb, 21 bp crossover period, 3 azimuth classes at 7 bp, caDNAno scaffold offset `±5 bp`, 10.5 bp/turn so `240/7 = 34.2857143°` per base pair; rise 0.34 nm/bp. **All four lattice constants are PARSED out of [`tile/HoneycombBondClassResidues.kt`](../../origami-engine/src/main/kotlin/tile/HoneycombBondClassResidues.kt)**, not transcribed. The square-lattice comparison period (32 bp, 8 bp step) is `CLAUDE.md`'s own, cited in the source. Counts are dimensionless; a yield is a **percentage of a stated denominator and the denominator travels with it**. No buffer, temperature or environment coordinate enters, so the result file's `regime` is `[]`. Retrieved **2026-08-23**; nothing installed but `poppler-utils`, already present |
