...
| **Provenance** | [`gpd/results/T-244-face-bond-class-residues.json`](../results/T-244-face-bond-class-residues.json) (`tile.HoneycombBondClassStudyKt`) and [`gpd/results/T-243-columns-from-row-spans.json`](../results/T-243-columns-from-row-spans.json) (`tile.HoneycombColumnWindowStudyKt`); model [`tile/HoneycombBondClassResidues.kt`](../../origami-engine/src/main/kotlin/tile/HoneycombBondClassResidues.kt), tests [`tile/HoneycombBondClassResiduesTest.kt`](../../origami-engine/src/test/kotlin/tile/HoneycombBondClassResiduesTest.kt) (**18**, written first and watched fail). Geometry consumed unmodified from [`structure/HoneycombRasterTurnSense.kt`](../../origami-engine/src/main/kotlin/structure/HoneycombRasterTurnSense.kt) (`C-0140`), [`tile/HoneycombFaceLattice.kt`](../../origami-engine/src/main/kotlin/tile/HoneycombFaceLattice.kt) and [`tile/HoneycombTwoLengthRaster.kt`](../../origami-engine/src/main/kotlin/tile/HoneycombTwoLengthRaster.kt) (`C-0141`, `C-0146`); the tile is `C-0142`'s, with `edgeX` and the column count lifted out as parameters. |
