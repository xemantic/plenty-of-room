...
| `E5a2`, `E5a1` | — | — | — | — | **the arm folds before reaching the stroke** — `C-0039`'s solver refuses it |
...
- **The stability floors and the per-path allowable are CITED**, not recomputed; they carry `C-0005`'s 123–214 % one-loop correction and `CH-0029`'s loading-rate dependence respectively. **No verdict here turns on either** — the binding bound is kinematic.
