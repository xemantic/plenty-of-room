...
| **Provenance** | [`gpd/results/T-204-collar-aspect-ratio.json`](../results/T-204-collar-aspect-ratio.json), produced by `tile.CollarAspectRatioStudyKt`; `collarShareRatio` in [`tile/HoneycombStationLattice.kt`](../../origami-engine/src/main/kotlin/tile/HoneycombStationLattice.kt), tests [`tile/CollarAspectRatioTest.kt`](../../src/test/kotlin/tile/CollarAspectRatioTest.kt) (3, written first and watched to fail). |
