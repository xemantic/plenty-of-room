...
- **Mean field, inherited whole.** `C-0005`'s one-loop correction is **123–214 %** of the leading term over this whole gap range — larger than the 1.39–2.58 margin this claim reports, and larger than the 1.0758× static margin it leaves untouched. (**RESTATED, `CH-0167`/`C-0137`**: this is an error bar on a LEVEL, and a margin read at a force-pinned operating point is not a level — the same-kind thresholds are a force **1.48–2.22×** smaller or a decay length **9.73 %** shorter.)
