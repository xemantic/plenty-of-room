...
| **Challenged by** | [`CH-0072`](../challenges/CH-0072-the-alignment-is-not-free-on-the-torsion-feasible-set.md), from [`C-0059`](C-0059-torsion-feasible-routing.md) (`T-124`), on **"the azimuth costs exactly nothing"** and on the **7 bp** row. Re-optimised on `C-0057`'s torsion-feasible set the pair still closes at every separation 6–12 bp, and its worst chord runs **33° / 69° / 57° / 6° / 6° / 33° / 33°** rather than 0.00° everywhere — so **7 bp is the worst of the seven** at 69.0° (12.8 % of the couple, and past the half right angle at which `C-0037`'s two-axis base cannot be represented at all), and **9–10 bp** delivers 6.0°. `CH-0056` is upheld; what fails is carrying a one-junction alignment result to a pair. |
