...
| **Partly superseded on one deliverable** | **Deliverable 6's decomposition** (*"rim floor 0.149 + the coupling's own sag"*) inherits `CH-0034`'s premise that the 0.149 is a floor, and [`CH-0071`](../challenges/CH-0071-the-saturation-floor-is-a-property-of-the-equal-spring-family.md) — from [`C-0058`](C-0058-non-uniform-coupling.md), which answers this claim's own *"Still open"* item 2 — shows it is the saturation of the **equal-spring family**: the two terms are not additive, and a redistributed 3 × 15 reaches **0.0753** of the stroke. **Every verdict of this claim stands**, all of them being about a uniform coupling at 15 paths, and `C-0058` re-measures that scheme with the distribution freed: 13 % admissible improvement, still 6.0× the tolerance and 1.96× worse than no coupling at all |
