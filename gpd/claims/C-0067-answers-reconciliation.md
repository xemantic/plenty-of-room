...
| **G3** | §3(g) stopped at iteration 10 | `C-0063` (0.0706 by placement with equal springs; `C-0058`'s rim rule **reverses sign** there) and `C-0064`/`CH-0077` (no distribution is flat at all five solved states — **0.1254** — **but the five states are four devices**, and over each device's own traversed range the minimax is **0.0373 / 0.0435 / 0.0620 / 0.0504**, all inside 0.10) added — *the five figures are `C-0064`'s final ones; an earlier draft of this row quoted its pre-determinism-repair run, and no verdict moves* |
