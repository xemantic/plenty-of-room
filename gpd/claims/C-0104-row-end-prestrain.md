...
**12 gate-named tests** in `origami-engine/src/test/kotlin/structure/CrossoverPrestrainTest.kt`, plus one in-study `check` and eight reproduction records.
