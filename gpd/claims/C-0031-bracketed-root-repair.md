...
| **Provenance** | `origami-engine/src/main/kotlin/brush/GraftedLayer.kt` (`bracketedRoot`); `src/test/kotlin/brush/BracketedRootTest.kt` (10 tests); `tools/P-15-rerun.sh`; full suite via `tools/verify.sh` |
