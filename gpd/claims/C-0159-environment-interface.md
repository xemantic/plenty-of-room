...
| **Provenance** | New sources [`environment/Environment.kt`](../../origami-engine/src/main/kotlin/environment/Environment.kt), [`environment/Regime.kt`](../../origami-engine/src/main/kotlin/environment/Regime.kt), [`environment/GraftedLayerEnvironment.kt`](../../origami-engine/src/main/kotlin/environment/GraftedLayerEnvironment.kt), [`environment/ElectrodeGapEnvironment.kt`](../../origami-engine/src/main/kotlin/environment/ElectrodeGapEnvironment.kt), [`environment/ElectrodeEdgeEnvironment.kt`](../../origami-engine/src/main/kotlin/environment/ElectrodeEdgeEnvironment.kt), [`quantities/ScreeningLength.kt`](../../origami-engine/src/main/kotlin/quantities/ScreeningLength.kt), [`quantities/StatedRatio.kt`](../../origami-engine/src/main/kotlin/quantities/StatedRatio.kt). **43 new gate-named tests, written first and watched fail**, in [`quantities/ScreeningLengthTest.kt`](../../origami-engine/src/test/kotlin/quantities/ScreeningLengthTest.kt) (9), [`environment/RegimeTest.kt`](../../origami-engine/src/test/kotlin/environment/RegimeTest.kt) (11), [`environment/EnvironmentTest.kt`](../../origami-engine/src/test/kotlin/environment/EnvironmentTest.kt) (14) and [`environment/CommittedReproductionTest.kt`](../../src/test/kotlin/environment/CommittedReproductionTest.kt) (9). The whole Kotlin suite is green with them in: **3 064 tests in 172 classes, 0 failures, 0 errors**. **Not one existing file was edited** — `git status` carries these paths as additions only — so **no committed result file moves, no study is re-run, and no claim's number changes** |
