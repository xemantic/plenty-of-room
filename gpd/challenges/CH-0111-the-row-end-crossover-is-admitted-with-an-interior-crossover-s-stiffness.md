...
| **Status** | **STANDS as a statement about the UNCERTAINTY, not about the verdict.** `C-0095`'s answer to *"may a crossover be drawn there"* is unaffected — that is a design rule and a folded structure. What is challenged is the **precision** of the number the admitted reading produces, and the claim that the two readings are alternatives rather than bounds |
