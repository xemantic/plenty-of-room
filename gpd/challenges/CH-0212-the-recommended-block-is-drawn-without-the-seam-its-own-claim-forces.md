...
| **Status** | **OPEN** — filed, not repaired. **No number moves and no verdict moves on either resolution**; what moves is which of two standing statements about the recommended block is the one a downstream reader may rely on |
