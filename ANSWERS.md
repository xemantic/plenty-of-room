...
1. **The tile is not a rigid plate, and the picture has to go.** It is rigid *exactly* under a uniform load —
   ...
   **as designed** and has not been shown to be flat **as built**, and closing that gap is `T-155`.
...
binding list, but for **margin** (1.39–2.58× against 1.87–3.47× at 0.5 mM) rather than for exclusion.
