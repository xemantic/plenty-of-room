...
object ResultInputs {
    ...
    val T_294: ResultInput =
        ResultInput("T-294", "T-294-the-tied-regrade-at-the-other-cross-section.json")
    ...
    val all: List<ResultInput> = listOf(
        ...
        T_283, T_284, T_285, T_286, T_287, T_289, T_291, T_292, T_293, T_294, T_295, T_296,
        T_297, T_298, T_299, T_3, T_30, T_300, T_302, T_303, T_304, T_307, T_310, T_315, T_316, T_319, T_322,
        T_323, T_3A, T_3B, T_4, T_40, T_5, T_50, T_5B, T_6, T_60, T_65, T_67, T_7, T_70, T_71, T_72,
