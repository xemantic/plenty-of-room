...
object ResultInputs {
    ...
    val T_330: ResultInput =
        ResultInput("T-330", "T-330-a-dishing-fit-and-the-parity-of-its-basis.json")
    ...
    val all: List<ResultInput> = listOf(
        ...
        T_322, T_323, T_330, T_3A, T_3B, T_4, T_40, T_5, T_50, T_5B, T_6, T_60, T_65, T_67, T_7, T_70,
        T_71, T_72, T_75, T_76, T_79, T_8, T_81, T_9, T_96, T_97, T_99, T_9B
    )
