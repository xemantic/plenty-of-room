...
object ResultInputs {
    ...
    val T_337: ResultInput = ResultInput("T-337", "T-337-the-exceedance-beside-every-verdict.json")
    val T_340: ResultInput = ResultInput("T-340", "T-340-a-working-tree-reading-at-the-emitter.json")
    ...
    val all: List<ResultInput> = listOf(
        ...
        T_322, T_323, T_326, T_327, T_330, T_332, T_334, T_336, T_337, T_340, T_3A, T_3B, T_4, T_40,
        T_5, T_50, T_5B, T_6, T_60, T_65, T_67, T_7, T_70, T_71, T_72, T_75, T_76, T_79, T_8, T_81,
        T_9, T_96, T_97, T_99, T_9B
    )
