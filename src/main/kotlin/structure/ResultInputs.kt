...
object ResultInputs {
    ...
    val T_316: ResultInput =
        ResultInput("T-316", "T-316-a-searched-distribution-at-the-resolved-link.json")
    ...
    val all: List<ResultInput> = listOf(
        ...
        T_299, T_3, T_30, T_300, T_302, T_303, T_304, T_307, T_310, T_315, T_316, T_319, T_3A,
        T_3B, T_4, T_40, T_5, T_50, T_5B, T_6, T_60, T_65, T_67, T_7, T_70, T_71, T_72, T_75,
